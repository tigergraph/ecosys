...
public class Driver {
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= 2; i++) {
            ...
            if ( i==1 ) {
                Supported_Versions = Supported_Versions + "v3_0_0_beta ";
            }
            if ( ( i==1 && Gsql_Client_Version.equalsIgnoreCase("v3_0_0_beta") ) ||
                 ( i==2 && (!Gsql_Client_Version.equalsIgnoreCase("v3_0_0_beta")) )){
                try {
                    System.out.println("========================");
                    System.out.println("Trying version: v3_0_0_beta");
                    com.tigergraph.v3_0_0_beta.client.Driver.main(args);
