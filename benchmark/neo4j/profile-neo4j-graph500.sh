...
# <path/to/seed/file> must be changed to the seed file path. e.g. /home/ubuntu/ecosys/benchmark/neo4j/graph500-22-seed
# <path/to/data/file> must be changed to the raw data file path. e.g. /home/ubuntu/ecosys/benchmark/neo4j/graph500-22
...
nohup python kn.py <path/to/seed/file>  300 neo4j  1 notes latency
...
nohup python kn.py <path/to/seed/file>  300 neo4j  2 notes latency
ps -ef | grep tsar | grep -v grep | awk '{print $2}' | xargs kill;
...
nohup python kn.py <path/to/seed/file>  10  neo4j  3 notes latency
ps -ef | grep tsar | grep -v grep | awk '{print $2}' | xargs kill;
...
nohup python kn.py <path/to/seed/file>  10  neo4j  6 notes latency
ps -ef | grep tsar | grep -v grep | awk '{print $2}' | xargs kill;
...
nohup python wcc.py <path/to/data/file> neo4j 3
ps -ef | grep tsar | grep -v grep | awk '{print $2}' | xargs kill;
...
nohup python pg.py <path/to/data/file> neo4j 10 3
ps -ef | grep tsar | grep -v grep | awk '{print $2}' | xargs kill;
