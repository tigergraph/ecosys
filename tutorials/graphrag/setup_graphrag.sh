...
curl -s https://raw.githubusercontent.com/tigergraph/ecosys/refs/heads/master/tutorials/graphrag/docker-compose.yml | sed "s/community:4.2.2/community:${tg_version}/g" > docker-compose.yml
