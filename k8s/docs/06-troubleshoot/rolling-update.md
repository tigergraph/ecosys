...
Events:
  ...
  Normal   Pulled             34m                kubelet            Successfully pulled image "docker.io/tigergraph/tigergraph-k8s:4.2.2" in 2.034685698s
  Normal   Pulled             32m                kubelet            Successfully pulled image "docker.io/tigergraph/tigergraph-k8s:4.2.2" in 338.940713ms
  ...
  Normal   Pulling              31m (x3 over 34m)  kubelet  Pulling image "docker.io/tigergraph/tigergraph-k8s:4.2.2"
  Normal   Pulled               31m                kubelet  Successfully pulled image "docker.io/tigergraph/tigergraph-k8s:4.2.2" in 315.864405ms
