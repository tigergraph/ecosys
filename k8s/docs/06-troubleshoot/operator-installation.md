...
- Verify Operator Installation
  ...
  tigergraph-operator-controller-manager   1/1     1            1           19d   manager      docker.io/tginternal/tigergraph-k8s-operator:1.7.3   control-plane=controller-manager
  ```

  From the output of the above command, you can figure out that the operator version is 1.7.3, docker.io/tigergraph/tigergraph-k8s-operator:1.7.3, you can also use the following helm command to get the current version of Operator:

  ```bash
  helm list -n tigergraph
  
  NAME            NAMESPACE       REVISION        UPDATED                                 STATUS          CHART                   APP VERSION
  tg-operator     tigergraph      1               2026-05-05 11:22:33.701059001 +0000 UTC deployed        tg-operator-1.7.3         1.7.3
