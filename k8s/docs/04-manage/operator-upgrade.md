...
- [How to upgrade TigerGraph Kubernetes Operator](#how-to-upgrade-tigergraph-kubernetes-operator)
  ...
  - [Upgrading from TigerGraph Operator 1.0.0 and later versions to version 1.7.3](#upgrading-from-tigergraph-operator-100-and-later-versions-to-version-173)
...
## Upgrading from TigerGraph Operator 1.0.0 and later versions to version 1.7.3

### Upgrading kubectl-tg plugin

To upgrade the kubectl-tg plugin for TigerGraph Operator 1.7.3, execute the following command:
...
There are no breaking changes in the TigerGraph CRDs for version 1.7.3 compared to versions 1.0.0 and above. You can upgrade the TigerGraph Operator by following these steps if you have an older version (1.0.0 or above) installed.
...
- Upgrade the TigerGraph Operator to the specific version using the `kubectl-tg` plugin
  ...
  tg-operator     tigergraph      2               2025-09-28 10:34:23.185036124 +0000 UTC deployed        tg-operator-1.7.3                1.7.3
  ```
...
NAME            NAMESPACE       REVISION        UPDATED                                 STATUS          CHART                           APP VERSION      
tg-operator     tigergraph      1               2025-09-10 10:34:23.185036124 +0000 UTC deployed        tg-operator-1.7.3                1.7.3
```
