...
public class QueryParserTest {
  private static final ComparableVersion TEST_VERSION = new ComparableVersion("99.99.99");
  ...
  public void testFormat() throws Exception {
    ...
    QueryParser parser = new QueryParser(null, query, parameters, 0, 0, TEST_VERSION, true);
    sb.append(parser.getEndpoint()).append(System.lineSeparator());

    query = "get vertex(Page) params(limit=?)";
    parameters = new HashMap<>(10);
    parameters.put(1, "3");
    parser = new QueryParser(null, query, parameters, 0, 0, TEST_VERSION, true);
    sb.append(parser.getEndpoint()).append(System.lineSeparator());
    ...
    parser = new QueryParser(null, query, null, 0, 0, TEST_VERSION, true);
    sb.append(parser.getEndpoint()).append(System.lineSeparator());
    ...
    query =
        "INSERT INTO edge Linkto(Page, Page, weight, is_active) VALUES('1000', '1001', 10.7,"
            + " FaLse)";
    parser = new QueryParser(null, query, null, 0, 1, TEST_VERSION, true);
