...
/**
 * Unit test for RestppResponse. The corresponding TigerGraph demo could be found at:
...
public class RestppResponseTest extends TestCase {
  ...
  public void testFormat() throws Exception {
    ...
    InputStream expected = getClass().getClassLoader().getResourceAsStream("response-expected.dat");
