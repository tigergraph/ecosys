...
import com.tigergraph.v2_3_2.common.Constant;
import com.tigergraph.v2_3_2.common.util.error.ReturnCode;
import java.io.File;
...
public class Client {
  ...
  public void interactiveShell() {
    ...
    if (!isFromGraphStudio) {
      //@GSQL_MACROS|#ifndef DEVELOPER_EDITION
      System.out.println("Welcome to TigerGraph.");
      //@GSQL_MACROS|#else
      System.out.println("Welcome to TigerGraph Developer Edition, for non-commercial use only.");
      //@GSQL_MACROS|#endif
    }
    ...
    //@GSQL_MACROS|#else
    prompt = ANSI_BLUE + "GSQL-Dev > " + ANSI_RESET;
    //@GSQL_MACROS|#endif
    ...
    try {
      ...
      cmdlogFile = new File(ClassLoader.getSystemClassLoader().getResource(".").getPath()
    ...
    switch (qb) {
      ...
      default:
        System.out.println("Please add the post action of " + qb
                           + " in com.tigergraph.v2_3_2.client/Client.java");
        System.exit(0);
    }
  }
